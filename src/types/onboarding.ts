...
export const ONBOARDING_SECTIONS: OnboardingSection[] = [
  {
    ...
    steps: [
      ...
      { key: 'A5',  num: '5',  task: 'Psychometric assessment scheduled',                  owner: 'AWS Admissions' },
      { key: 'A6',  num: '6',  task: 'Counselling session completed',                      owner: 'Counsellor' },
      { key: 'A7',  num: '7',  task: 'Exact Path diagnostic completed',                    owner: 'Student' },
      { key: 'A8',  num: '8',  task: 'Subject selection documents shared',                 owner: 'AWS Admissions' },
      { key: 'A9',  num: '9',  task: 'Final subject choices meeting held',                 owner: 'Student Success Consultant' },
      { key: 'A10', num: '10', task: 'Policies signed (student & family)',                 owner: 'Family / Student' },
      { key: 'A11', num: '11', task: 'School calendar sent',                               owner: 'AWS Onboarding Team' },
      ...
      { key: 'A14', num: '14', task: 'Weekly class schedule sent',                         owner: 'Success Coach' },
      { key: 'A15', num: '15', task: 'First live class attended',                          owner: 'Student' },
      { key: 'A16', num: '16', task: 'Weekly Success Manager check-ins (mandatory, ongoing)', owner: 'Success Manager' },
      { key: 'A17', num: '17', task: 'Monthly report sent to family (ongoing)',            owner: 'Success Manager' },
    ],
  },
  {
    id: 'B',
